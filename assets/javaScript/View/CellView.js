...
cc.Class({
    ...
    setSelect: function(flag){
        ...
        else if(flag == false && this.model.status == CELL_STATUS.BIRD){
            // console.log("走了没");
            // this.node.getComponent(cc.Sprite).spriteFrame = this.defaultFrame;
            animation.play(CELL_STATUS.ROMC);
        }
        else if(flag == false  && this.model.status == CELL_STATUS.BOOM){
            // this.node.getComponent(cc.Sprite).spriteFrame = this.defaultFrame;
            animation.play(CELL_STATUS.BOOM);
        }
        else if(flag == false  && this.model.status == CELL_STATUS.LINE){
            // this.node.getComponent(cc.Sprite).spriteFrame = this.tempFrame;
            animation.play(CELL_STATUS.ROMC);
        }
        bg.active = flag; 
        this.isSelect = flag;
